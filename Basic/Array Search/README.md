<h2><a href="https://www.geeksforgeeks.org/problems/search-an-element-in-an-array-1587115621/1">Array Search</a></h2><p><img src="https://img.shields.io/badge/Difficulty-Basic-0ea5e9?style=flat&labelColor=111827" alt="Difficulty Basic" /></p><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given an array, <strong>arr[]</strong> of n integers, and an integer element <strong>x</strong>, find whether element x is present in the array. Return the index of the first occurrence of x in the array, or -1 if it doesn't exist.</span></p>
